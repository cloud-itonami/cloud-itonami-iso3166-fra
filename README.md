# cloud-itonami-iso3166-fra

Open ISO 3166 Blueprint for **FRA**: France.
...
tax registration, and EU single-market rules in France, so the operator
...
- **Not the government of France.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to French-licensed counsel
...
(ISO 3166 `FRA`). Required capabilities:
